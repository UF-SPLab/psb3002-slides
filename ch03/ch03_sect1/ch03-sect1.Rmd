...
![:positionImage 15%, 30%, 0deg, 70%](image1.jpeg)
![:positionImage 20%, 82%, 0deg, 75%](image2.png)
...
![:positionImage 35%, 0%, 0deg, 60%](image9b.png)
![:positionImage 30%, 63%, 0deg, 62%](image10.jpeg)
![:positionImage 30%, 75%, 0deg, 95%](image9a.png)

---
template: 3-1-7

![:positionImage 12%, 55%, 0deg, 95%](image12.png)

![:positionImage 20%, 33%, 0deg, 79%](image13.png)
![:positionImage 55%, 33%, 0deg, 71%](image11.png)
